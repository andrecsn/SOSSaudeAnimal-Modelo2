<%@ Page Title="" Language="C#" MasterPageFile="~/Cadastros/Site1.Master" AutoEventWireup="true" CodeBehind="CadastroRaca.aspx.cs" Inherits="ClinicaVeterinaria.Cadastros.raca" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Corpo" runat="server">

    <form id="form1" runat="server" class="jumbotron">

        <h2><asp:Label ID="lblTitulo" runat="server" Text="Cadastrar Raça"></asp:Label></h2>
        <h4>Preencha todos os dados de raça corretamente.</h4>
