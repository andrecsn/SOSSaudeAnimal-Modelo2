...
<asp:Content ID="Content1" ContentPlaceHolderID="Corpo" runat="server">
    ...
    <form id="form1" runat="server" class="jumbotron">
        ...
        <h2>Prontuário - Lista de Animal e Responsável</h2>
        ...
        <asp:GridView ID="gridProntuario" runat="server" AutoGenerateColumns="False" CssClass="table table-hover" GridLines="None"
